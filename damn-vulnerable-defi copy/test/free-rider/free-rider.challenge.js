...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        this.attackingContract = await FreeRiderAttackerFactory.deploy(
        ...
        // call attack
        await this.attackingContract.connect(attacker).attack(NFT_PRICE)

        await this.attackingContract.connect(attacker).transferNFT()
        // withdraw funds
        await this.attackingContract.connect(attacker).withdraw()
    });
