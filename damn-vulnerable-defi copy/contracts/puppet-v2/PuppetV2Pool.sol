...
contract PuppetV2Pool {
    ...
    function _getOracleQuote(uint256 amount) private view returns (uint256) {
        ...
        // priceWETH = (amount_ReservesToken * reservesWETH) / reservesToken
        // err still if the pair isn't liquid enough we can still swap tokens for ETH and drive
        // the price of WETH for this pair down significantly
        // in the test, the pair has 10 WETH and 100 tokens
        // meaning that WETH/Token = 0.1 and token/WETH = 10
